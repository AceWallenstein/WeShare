...
public class GoodsBean {
    ...
    public GoodsBean(String goods_title, String membershipPrice, String nonMembershipPrice, String goods_pic, String paymentsNum) {
    ...
    public GoodsBean(String goods_title, String membershipPrice, String nonMembershipPrice, String goods_pic, String paymentsNum,String collectionNum) {
        this.goods_title = goods_title;
        MembershipPrice = membershipPrice;
        NonMembershipPrice = nonMembershipPrice;
        this.goods_pic = goods_pic;
